...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.scalajs.npm" %%% "transducers-js" % scalaJsIOVersion
    ))
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/rx</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/rxjs.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/rxjs.git</developerConnection>
        <url>github.com/scalajs-io/rxjs.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
